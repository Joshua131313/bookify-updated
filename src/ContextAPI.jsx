...
let ContextAppProvider=(props)=>{
  ...
  return (
    <ContextApp.Provider value={{userispro, allusers, setAllusers,favoritesbool, setFavoritesbool, add, setAdd, notification, setNotification, notifibool, setNotifibool, keyword, setKeyword, scrollto, setScrollto, loader, setLoader, setHide, hide, allbooksdoc, morefilters, setMorefilters, gridview, setGridview}}>
      {props.children}
    </ContextApp.Provider>
  )
}
